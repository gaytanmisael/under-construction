...
<head> 
	<meta charset="utf-8" />
	<title>Nuestra Gente - Under Construction</title>
...
<body>
	<div id="level">
		<div id="content">
			...
			<div id="title">
				<img src="img/logo.png" alt="Nuestra Gente" width="400"/>
				<h1>Estamos bajo mantenimiento</h1>
				<p>Estamos dandole mantenimiento a nuestra pagina por el momento dentro de unas horas estara lista la pagina.</p>
			</div>
		</div>
	</div>
</body>
